...
export function Footer() {
	...
	return (
		<section className="flex flex-col items-center gap-16 px-responsive py-responsive">
			<div className="flex flex-col gap-16 md:flex-row md:justify-between lg:gap-20 xl:gap-32">
			...
			<Link href="#" className="flex items-center gap-2">
				<RiArrowUpLine className="size-4" /> Scroll to the top
			</Link>
		</section>
	);
}
